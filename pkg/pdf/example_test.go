...
func ExamplePdfMaroto_Barcode() {
	...
	m.Col(12, func() {
		_ = m.Barcode("https://github.com/miroslavhajek/maroto", props.Barcode{
			Percent:    75,
...
func ExamplePdfMaroto_QrCode() {
	...
	m.Row(rowHeight, func() {
		m.Col(12, func() {
			m.QrCode("https://godoc.org/github.com/miroslavhajek/maroto", props.Rect{
				Left:    5,
				Top:     5,
				Center:  false,
				Percent: 80,
...
func ExamplePdfMaroto_DataMatrixCode() {
	...
	m.Row(rowHeight, func() {
		m.Col(12, func() {
			m.DataMatrixCode("https://godoc.org/github.com/miroslavhajek/maroto", props.Rect{
				Left:    5,
				Top:     5,
				Center:  false,
				Percent: 80,
